...
namespace RealEstate_Dapper_UI.Areas.EstateAgent.ViewComponents.EstateAgentNavbarViewComponents
{
    public class _NavbarLastThreeMessageComponentPartial:ViewComponent
    {
        ...
        public _NavbarLastThreeMessageComponentPartial(IHttpClientFactory httpClientFactory, ILoginService loginService = null)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var responseMassage = await client.GetAsync("https://localhost:44305/api/Messages?id=" + id);
